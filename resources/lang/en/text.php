...
return [
    ...
    'add_semester'=>'add term',
    'set_grading_scale'=>'set grading scale',
    'set_semester_type'=>'set term type',
    'semester_type'=>'term type',
    'word_change'=>'change',
    ...
    'word_users'=> 'users',
    'first_semester_minimum' => 'first term minimum',
    'second_semester_minimum' => 'second term minimum',
    'exam_results_charges' => 'exam results charges',
    'clear_students' => 'clear students',
    'word_courses'=>'subjects',
    'FORM_B'=>'FORM B',
    'course_registration'=>'subject registration',
    'course_title'=>'subject title',
    'word_action'=>'action',
    'sign_course'=>'sign subject',
    'view_courses'=>'view subjects',
    ...
    'formb_title'=>'registered subjects for :semester :year',
    ...
    'CA'=>'CA',
    'total_courses_attempted'=>'total subjects attempted',
    'total_courses_passed'=>'total subjects passed',
    ...
    'date_line'=>'date line',
    'course_registration_over'=>'course registration is closed for this term',
    'program_settings'=>'program settings',
    'maximum_credits'=>'maximum credits',
    'ca_totals'=>'test totals',
    'exam_totals'=>'EXAM totals',
    'add_to_cart'=>'add to cart',
    'sign_resit_course'=>'sign resit subject',
    'prase_course_search'=>'search subject by subject code or title',
    'word_sign'=>'sign',
    'word_send'=>'send',
    ...
    'payment_details_statement'=>'You are about to register for :qnty resit subjects. This will cost you :amnt CFA. Click "Proceed" to make payment.',
    ...
    'ca_dateline'=>'test dateline',
    'exam_dateline'=>'exam dateline',
    'exam_results'=>'exam results',
    'ca_results'=>'test results',
    ...
    'semester_results_report'=>'term results report',
    'CA_only'=>'test only',
    ...
    'word_open'=>'open',
    'word_closed'=>'closed',
    'download_courses'=>'download subjects',
    ...
    'SEMESTER_RESULT_CHARGES'=>'TERM RESULT CHARGES',
    ...
    'set_course_registration_dateline'=>'set subject registration dateline',
    'DATELINE_NOT_SET'=>"DATE LINE NOT SET",
    'page_not_found'=>'Program Not Found.',
    'set_current_semester'=>'set current term',
    ...
    'resit_course_list_for'=>'resit subject list for :item',
    ...
    'CA_total_not_set_for'=>"test TOTAL not set for :program",
    'CA_mark_exceeds_totals'=>"test mark for :course exceeds test TOTALS for student :student",
    'exam_total_not_set_for'=>"EXAM TOTAL not set for :program",
    'exam_mark_exceeds_totals'=>"EXAM mark for :course exceeds test TOTALS for student :student",
    'already_has_ca_mark'=>":student already has a test mark for :course this academic year and will not be added. Clear or delete record and re-import to make sure all data is correct</br>",
    ...
    'manage_semesters_under'=>'manage terms under :unit',
    'create_semesters_under'=>'create terms under :unit',
    'edit_semester'=>'edit term',
    'set_semester_type_for'=>'set term type for :unit',
    'manage_program_levels'=>'manage section classes',
    'program_levels_for'=>'classes for :unit',
    'level_not_in_program'=>'class does not exist in this program',
    ...
    'student_CA_results'=>'student test results',
    'fill_CA_results_for'=>'fill test results for :course | :class',
    'fill_exam_results_for'=>'fill EXAM results for :course | :class',
    'import_CA_results_for'=>'import test results for :course | :class',
    ...
    'ca_results_already_exist_for'=>'test results already exist for :item',
    'exam_results_already_exist_for'=>'test results already exist for :item',
    ...
    'sign_course_log'=>'sign subject log',
    ...
    'by_course'=>'by subject',
    'by_month'=>'by month',
    'hours_covered'=>'hours covered',
    'course_hours'=>'course hours', 
    'change_course_coefficienit'=>'change subject coefficient',
    'word_hours'=>'hours',
    ...
    'no_of_courses'=>'No of subjects',
    'hourly_wages'=>'hourly wages',
    'add_wages'=>'add wages',
    'per_teacher'=>'per teacher',
    'per_background_per_level'=>'per section per class',
    'word_select'=>'select',
    ...
    'pending_courses'=>'pending subjects', 
    ...
    'unvalidated_courses'=>'unvalidated subjects',
    ...
    'import_course_codes'=>'import subject codes',
    ...
    'no_courses_registered_phrase'=>'You did not register for any subjects this term. If you registered and payed offline, contact your secretariat for rectification',
